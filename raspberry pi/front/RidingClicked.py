...
class RidingClicked(QDialog):
    ...
    def formSetting(self):
        ...
        if (self.setting.fontSize2=='S'):
            self.heartRate.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 60px Arial;")
            self.distance.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 14px Arial;")
            self.speed.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 60px Arial;margin-left:10px;")
            self.kmh.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 20px Arial;")
            self.ridingTime.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 14px Arial;")
            self.ridingDistance.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 14px Arial;")
        elif (self.setting.fontSize2=='M'):
            self.heartRate.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 70px Arial;")
            self.distance.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 16px Arial;")
            self.speed.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 70px Arial;")
            self.kmh.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 30px Arial;")
            self.ridingTime.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 15px Arial;")
            self.ridingDistance.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 15px Arial;")
        else :
            self.heartRate.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 80px Arial;")
            self.distance.setStyleSheet("background-color:rgba(255,255,255,0);color:white;font:bold 18px Arial;")
        ...
        self.backButton.setStyleSheet("font:bold "+self.setting.fontSize+"px Arial; color:rgb(41,41,41); border:0px; border-radius:5px; background-color:rgb(106,230,197); outline:0px;")
    ...
    def navUpdate(self, distance, direction):  # 네비 테스트 완료 후 변경
        ...
        self.distance.setText(distance + 'm')
    ...
    def speedUpdate(self, data):  # 속도 데이터 수신 콜백함수
        ...
        self.ridingMeter = self.receiveSpeedCount*self.wheelDiameter*0.0000001
        if (self.ridingMeter < 1):
            self.distanceResult = 0
        else :
            self.distanceResult = self.receiveSpeedCount*self.wheelDiameter*0.0000001
        self.ridingDistance.setText("Riding Distance : "+str(self.distanceResult)+"km/h")
    ...
    def BluetoothRead(self, text):
        ...
        print(type(self.textList[0]))
        print(type(self.textList[1]))
